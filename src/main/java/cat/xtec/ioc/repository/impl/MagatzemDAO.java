...
public class MagatzemDAO implements MagatzemRepository {
    ...
    public MagatzemDAO() {
        try {
            dBConnection = (Dbconnection) new InitialContext().lookup("java:global/dawm07eac4magatzeme/Dbconnection");
    ...
    public List<Magatzem> getAllMagatzems(){
        try {
            ...
            */
            ...
            String qry = "select codi, denominacio, actiu, localitat from magatzems";
            PreparedStatement preparedStatement = getPreparedStatement(qry);
    ...
    public List<Magatzem> getMagatzemsByLocalitat(String localitat){
        try {
            ...
            getPreparedStatement d'aquesta mateixa classe)
            */
            String qry = "select codi, denominacio, actiu, localitat from magatzems where localitat = ?";
            PreparedStatement preparedStatement = getPreparedStatement(qry);
